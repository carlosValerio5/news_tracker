...
jest.mock('../components/TitleBar', () => () => <div data-testid="mock-titlebar">TitleBar</div>);
jest.mock('../components/CustomGoogleLogin', () => () => <button data-testid="mock-google-login">Sign in with Google</button>);
...
describe('RegisterPage', () => {
  test('renders heading, description, mocked TitleBar and Google login, and login link', () => {
    ...
    // Description text
    expect(screen.getByText(/Create your account with Google./i)).toBeInTheDocument();
